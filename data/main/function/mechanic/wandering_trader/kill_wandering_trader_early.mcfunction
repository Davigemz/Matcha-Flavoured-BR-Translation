...
execute at @a run execute if score @p wandering_trader_timer_score >= 0 wandering_trader_timer_score run tellraw @p {"translate":"message.kleispack.wandering_trader.sight.lost","color":"gray"}
